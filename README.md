...
Functional CSS for min-height-percentages

## Filesize

| File | Size |
|------|------|
| `dist/min-height-percentages.css` | 16049 bytes |
| `dist/min-height-percentages.min.css` | 10635 bytes (1436 Gzipped) |

## Install

```sh
npm install css-min-height-percentages
```
...
```html
<link rel="stylesheet" href="https://unpkg.com/css-min-height-percentages/dist/min-height-percentages.min.css">
```

### Direct

```html
<link rel="stylesheet" href="path/to/css-min-height-percentages/dist/min-height-percentages.min.css">
```
...
| `.mn-hi-1-s` | `min-height: 1%;` |
| `.mn-hi-2-s` | `min-height: 2%;` |
| `.mn-hi-3-s` | `min-height: 3%;` |
| `.mn-hi-4-s` | `min-height: 4%;` |
| `.mn-hi-5-s` | `min-height: 5%;` |
| `.mn-hi-6-s` | `min-height: 6%;` |
| `.mn-hi-7-s` | `min-height: 7%;` |
| `.mn-hi-8-s` | `min-height: 8%;` |
| `.mn-hi-9-s` | `min-height: 9%;` |
| `.mn-hi-10-s` | `min-height: 10%;` |
| `.mn-hi-11-s` | `min-height: 11%;` |
| `.mn-hi-12-s` | `min-height: 12%;` |
| `.mn-hi-13-s` | `min-height: 13%;` |
| `.mn-hi-14-s` | `min-height: 14%;` |
| `.mn-hi-15-s` | `min-height: 15%;` |
| `.mn-hi-16-s` | `min-height: 16%;` |
| `.mn-hi-17-s` | `min-height: 17%;` |
| `.mn-hi-18-s` | `min-height: 18%;` |
| `.mn-hi-19-s` | `min-height: 19%;` |
| `.mn-hi-20-s` | `min-height: 20%;` |
| `.mn-hi-21-s` | `min-height: 21%;` |
| `.mn-hi-22-s` | `min-height: 22%;` |
| `.mn-hi-23-s` | `min-height: 23%;` |
| `.mn-hi-24-s` | `min-height: 24%;` |
| `.mn-hi-25-s` | `min-height: 25%;` |
| `.mn-hi-26-s` | `min-height: 26%;` |
| `.mn-hi-27-s` | `min-height: 27%;` |
| `.mn-hi-28-s` | `min-height: 28%;` |
| `.mn-hi-29-s` | `min-height: 29%;` |
| `.mn-hi-30-s` | `min-height: 30%;` |
| `.mn-hi-31-s` | `min-height: 31%;` |
| `.mn-hi-32-s` | `min-height: 32%;` |
| `.mn-hi-33-s` | `min-height: 33%;` |
| `.mn-hi-34-s` | `min-height: 34%;` |
| `.mn-hi-35-s` | `min-height: 35%;` |
| `.mn-hi-36-s` | `min-height: 36%;` |
| `.mn-hi-37-s` | `min-height: 37%;` |
| `.mn-hi-38-s` | `min-height: 38%;` |
| `.mn-hi-39-s` | `min-height: 39%;` |
| `.mn-hi-40-s` | `min-height: 40%;` |
| `.mn-hi-41-s` | `min-height: 41%;` |
| `.mn-hi-42-s` | `min-height: 42%;` |
| `.mn-hi-43-s` | `min-height: 43%;` |
| `.mn-hi-44-s` | `min-height: 44%;` |
| `.mn-hi-45-s` | `min-height: 45%;` |
| `.mn-hi-46-s` | `min-height: 46%;` |
| `.mn-hi-47-s` | `min-height: 47%;` |
| `.mn-hi-48-s` | `min-height: 48%;` |
| `.mn-hi-49-s` | `min-height: 49%;` |
| `.mn-hi-50-s` | `min-height: 50%;` |
| `.mn-hi-51-s` | `min-height: 51%;` |
| `.mn-hi-52-s` | `min-height: 52%;` |
| `.mn-hi-53-s` | `min-height: 53%;` |
| `.mn-hi-54-s` | `min-height: 54%;` |
| `.mn-hi-55-s` | `min-height: 55%;` |
| `.mn-hi-56-s` | `min-height: 56%;` |
| `.mn-hi-57-s` | `min-height: 57%;` |
| `.mn-hi-58-s` | `min-height: 58%;` |
| `.mn-hi-59-s` | `min-height: 59%;` |
| `.mn-hi-60-s` | `min-height: 60%;` |
| `.mn-hi-61-s` | `min-height: 61%;` |
| `.mn-hi-62-s` | `min-height: 62%;` |
| `.mn-hi-63-s` | `min-height: 63%;` |
| `.mn-hi-64-s` | `min-height: 64%;` |
| `.mn-hi-65-s` | `min-height: 65%;` |
| `.mn-hi-66-s` | `min-height: 66%;` |
| `.mn-hi-67-s` | `min-height: 67%;` |
| `.mn-hi-68-s` | `min-height: 68%;` |
| `.mn-hi-69-s` | `min-height: 69%;` |
| `.mn-hi-70-s` | `min-height: 70%;` |
| `.mn-hi-71-s` | `min-height: 71%;` |
| `.mn-hi-72-s` | `min-height: 72%;` |
| `.mn-hi-73-s` | `min-height: 73%;` |
| `.mn-hi-74-s` | `min-height: 74%;` |
| `.mn-hi-75-s` | `min-height: 75%;` |
| `.mn-hi-76-s` | `min-height: 76%;` |
| `.mn-hi-77-s` | `min-height: 77%;` |
| `.mn-hi-78-s` | `min-height: 78%;` |
| `.mn-hi-79-s` | `min-height: 79%;` |
| `.mn-hi-80-s` | `min-height: 80%;` |
| `.mn-hi-81-s` | `min-height: 81%;` |
| `.mn-hi-82-s` | `min-height: 82%;` |
| `.mn-hi-83-s` | `min-height: 83%;` |
| `.mn-hi-84-s` | `min-height: 84%;` |
| `.mn-hi-85-s` | `min-height: 85%;` |
| `.mn-hi-86-s` | `min-height: 86%;` |
| `.mn-hi-87-s` | `min-height: 87%;` |
| `.mn-hi-88-s` | `min-height: 88%;` |
| `.mn-hi-89-s` | `min-height: 89%;` |
| `.mn-hi-90-s` | `min-height: 90%;` |
| `.mn-hi-91-s` | `min-height: 91%;` |
| `.mn-hi-92-s` | `min-height: 92%;` |
| `.mn-hi-93-s` | `min-height: 93%;` |
| `.mn-hi-94-s` | `min-height: 94%;` |
| `.mn-hi-95-s` | `min-height: 95%;` |
| `.mn-hi-96-s` | `min-height: 96%;` |
| `.mn-hi-97-s` | `min-height: 97%;` |
| `.mn-hi-98-s` | `min-height: 98%;` |
| `.mn-hi-99-s` | `min-height: 99%;` |
| `.mn-hi-100-s` | `min-height: 100%;` |
...
Example: `.mn-hi-1-m` applies the property at the medium breakpoint and above.
...
Processes `src/min-height-percentages.css` with [Lightning CSS](https://lightningcss.dev) and outputs to `dist/`.

- `dist/min-height-percentages.css` — formatted
- `dist/min-height-percentages.min.css` — minified
